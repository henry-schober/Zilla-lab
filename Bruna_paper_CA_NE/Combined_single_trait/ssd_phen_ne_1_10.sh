...
ln -s /data/henry/henrys/first_lac/new_england/phenotypes_ne_no_small_first_lac .
ln -s /data/henry/henrys/pedigrees/ped_ne/new_ped_ne .
ln -s /data/henry/henrys/first_lac/new_england/cgs_30 .
...
mv phen_ne.clean.dat phen_ne.clean.dat_$i
