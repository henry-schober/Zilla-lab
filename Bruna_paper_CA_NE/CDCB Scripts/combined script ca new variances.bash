ln -s /data/henry/henrys/phenotypes/phen_red_ca .
...
#here we want to manually cp the renum_ca.par to renum.red.par file and then insert the previous variances that we got
