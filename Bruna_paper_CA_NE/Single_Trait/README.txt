...
Workflow
  ...
  2. Run either Pheno_cgs.sh or cgs_pheno.sh, both work but cgs_pheno.sh is a script that includes a for loop so it makes all of the phenotypes_no_small files for both states
