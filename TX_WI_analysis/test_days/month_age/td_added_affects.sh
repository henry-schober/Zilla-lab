...
# continuation of script, get rid of small age groups so for TX, get rid of animals with age of 15, 16, and 17 months

awk '$9 >= 18' phen_TX > phen_TX_temp



#then each class is every 2 so 18 and 19 are 1, 20 and 21 are 2, and so on until 36 where it is by itself and we have to classes

awk '{print $0, int(($9 -18)/2 +1)}' phen_TX_temp > phen_TX_temp2
#do this for both TX and WI

awk '{print $1, $2, $3, $4, $5, $6, $7, $8, $13, $10, $11, $12}' phen_TX_temp2 > phen_TX
